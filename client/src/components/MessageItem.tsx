...
// @ts-ignore
const MessageItem = ({message, selected, toggleSelect, openPreview, id}) => {
  const getClass = () => {
  ...
  return (
    <div id={id} className="message-item-observe">
      <Cell
        className={getClass()}
        before={
          <Checkbox
          ...
          <div className="my-auto preview row align-content-center">
            ...
            <div className="col-9">
              <h6 className="m-0 w-100 title-message d-flex">
                {
                  message.finance &&
                    <span className="material-icons-outlined my-auto me-1 finances-indicator">paid</span>
                }
